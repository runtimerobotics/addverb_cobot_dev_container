#include "addverb_cobot_controllers/effort_controller.h"
...
namespace addverb_cobot_controllers
{
     ...
     */
    controller_interface::CallbackReturn EffortController::on_init()
    {
      try
      {
      ...
      {
        RCLCPP_WARN(get_node()->get_logger(), "Exception raised in initialising EffortController");
        return controller_interface::CallbackReturn::ERROR;
      }

      RCLCPP_INFO(get_node()->get_logger(), "Initialised EffortController");
     ...
     * @return controller_interface::CallbackReturn
     */
    controller_interface::CallbackReturn EffortController::on_configure(const rclcpp_lifecycle::State& /*previous_state*/)
    {
      RCLCPP_INFO(get_node()->get_logger(), "Configured EffortController");
      return controller_interface::CallbackReturn::SUCCESS;
    }
     ...
     */
    controller_interface::InterfaceConfiguration EffortController::command_interface_configuration() const
    {
     ...
     * @return controller_interface::InterfaceConfiguration
     */
    controller_interface::InterfaceConfiguration EffortController::state_interface_configuration() const
    {
        controller_interface::InterfaceConfiguration config;
        config.type = controller_interface::interface_configuration_type::INDIVIDUAL;
     ...
     * @return controller_interface::CallbackReturn
     */
    controller_interface::CallbackReturn EffortController::on_activate(const rclcpp_lifecycle::State&)
    {
      RCLCPP_INFO(get_node()->get_logger(), "Activating EffortController");
       ...
       effort_subscriber_ = get_node()->create_subscription<std_msgs::msg::Float64MultiArray>(
        ...
        std::bind(&EffortController::effort_command_callback_, this, std::placeholders::_1));
     ...
     * @return controller_interface::CallbackReturn
     */
    controller_interface::CallbackReturn EffortController::on_deactivate(const rclcpp_lifecycle::State&)
    {
      RCLCPP_INFO(get_node()->get_logger(), "Deactivated EffortController");
      return controller_interface::CallbackReturn::SUCCESS;
    }
     ...
     */
    controller_interface::return_type EffortController::update(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/)
    {
      ...
      if (in_error_)
      {
        std::fill(commanded_effort_.begin(), commanded_effort_.end(), 0.0);
      }
     ...
     */
    void EffortController::effort_command_callback_(const std_msgs::msg::Float64MultiArray::SharedPtr msg)
    {
...
PLUGINLIB_EXPORT_CLASS(
    addverb_cobot_controllers::EffortController,
