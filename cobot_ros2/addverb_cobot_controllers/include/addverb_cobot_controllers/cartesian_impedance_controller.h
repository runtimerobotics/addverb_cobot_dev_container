 ...
 * @brief Cartesian Impedance Controller - for sending Cartesian impedance control commands to the robot
 * @version 0.1
 * @date 2025-07-12
 *
...
#ifndef CARTESIAN_IMPEDANCE_CONTROLLER_H_
#define CARTESIAN_IMPEDANCE_CONTROLLER_H_
...
namespace addverb_cobot_controllers
{
    ...
    {
    public:
        RCLCPP_SHARED_PTR_DEFINITIONS(CartesianImpedanceController)
    ...
    private:
        ...
        std::vector<double> ft_force_;
        std::vector<double> target_force_;
